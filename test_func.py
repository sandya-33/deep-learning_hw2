...
from Rnn import test_data, test, MODELS, encoderRNN, decoderRNN, attention
from bleu_eval import BLEU
import pickle

model = torch.load('SavedModel/model0.h5', map_location=lambda storage, loc: storage)
model = model.cuda()
filepath = '/home/sandyap/hw2/MLDS_hw2_1_data/testing_data/feat'
print(sys.argv[1])
...
test = json.load(open('/home/sandyap/hw2/MLDS_hw2_1_data/testing_label.json'))
op = sys.argv[2]
arr = {}
bleu=[]
with open(op,'r') as f:
